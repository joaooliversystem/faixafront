    ...
    return (
        <>
            ...
            >
                ...
                >
                    A Nova Era em anúncios de acompanhantes no Brasil
                    <br />
                    <span
                        style={{
                            fontSize: "18px",
            ...
            <section className="bg-dark py-1" style={{ width: "100%", minHeight: "220px", marginBottom: '0' }}>
                <div
                    className="container"
                    style={{
                        margin: '15px 0px',
            ...
            <section className="bg-dark py-1" style={{ width: "100%" }}>
            ...
            <section className="bg-dark py-1" style={{ width: "100%", minHeight: "250px" }}>
                <div className="container">
                    <div className="row">
                        <div className="d-flex align-items-center flex-column">
                            <div className="ms-3" style={{ marginTop: '20px', marginBottom: '20px' }}>
            ...
            >
                ...
                >
                    ...
                    >Acompanhantes em destaque em todo o Brasil</h3>
            ...
            <footer className="footer">
                <div
                    className="footer-container d-flex flex-column gap-1"
                    style={{
                        justifyContent: 'center',
                        alignItems: 'center',
                    }}
                >
                    ...
                    <div
                        style={{ fontSize: "13px" }}
                    >©2024 <a target="_blank" href="https://faixarosa.com.br/">Faixa Rosa</a> - Direitos reservados</div>
                    <div
                        style={{ fontSize: "13px" }}
                    >CNPJ - 53.839.625/0001-08</div>
                    <div
                        style={{ fontSize: "13px" }}
